...
The Interface \hyperlink{interfacecom_1_1libsensorj_1_1concreteactuator_1_1interfaces_1_1IStepperMotor}{I\+Stepper\+Motor}. 
...
{\em revolutions} & the revolutions \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em milliseconds} & the new step interval \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em milliseconds} & the milliseconds \\
\hline
{\em nanoseconds} & the nanoseconds \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em sequence} & the new step sequence \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em steps} & the new steps per revolution \\
\hline
\end{DoxyParams}
