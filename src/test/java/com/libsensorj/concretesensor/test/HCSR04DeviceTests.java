 ...
 * ORGANIZATION  :  IFBA
 * PROJECT       :  libsensorj
 * FILENAME      :  HCSR04DeviceTests.java  
 * 
...
/**
 * The Class HCSR04DeviceTests.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest(HCSR04Device.class)
@PowerMockIgnore({ "javax.management.*" })
public class HCSR04DeviceTests {
    ...
    private static final String DISTANCE_METHOD = "getDistance";
    ...
    public void testGetDistance() {
        HCSR04Device device = PowerMockito.spy(new HCSR04Device());

        try {
            when(device, method(HCSR04Device.class, DISTANCE_METHOD))
        ...
        Assert.assertEquals(10, device.getDistance(), 0);
    }
